...
module.exports = {
  ...
  async up(queryInterface, _Sequelize) {
    ...
    await queryInterface.bulkInsert("users", [
      {
        id: 1,
        name: "Siswanto",
        email: "siswanto@example.com",
        password:
          "$2a$12$.HOb8SlLxGN4usHDihNaQe6IFDodXO09pO6Nfi.M96XzcTJ9F1HDu", // WantoPw1
      },
      {
        id: 2,
        name: "Siswa",
    ...
    await queryInterface.bulkInsert("mode_pembelajarans", [
      { id: 1, name: "Tema", kelas_id: 1 },
      { id: 2, name: "Topik", kelas_id: 1 },
      { id: 3, name: "Tema", kelas_id: 2 },
      { id: 4, name: "Topik", kelas_id: 2 },
      { id: 5, name: "Tema", kelas_id: 3 },
